...
project.folder <- paste0(print(here::here()),'/')
  ...
  figures.folder <- paste0(project.folder, "figures/")
    robbie.figures.folder <- paste0(figures.folder, "robbie_figures/")
      figure1.folder <- paste0(robbie.figures.folder,"figure1/")
  tables.folder <- paste0(project.folder, "tables/")
    robbie.tables.folder <- paste0(tables.folder, "robbie_tables/")
      table1.folder <- paste0(robbie.tables.folder, "table1/")
      table2.folder <- paste0(robbie.tables.folder, "table2/")
