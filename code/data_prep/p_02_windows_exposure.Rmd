...
1) In the original dataset there is a total of 3,941 cases. If each case has 5 controls then there should be a total of 19,705 controls, that is, 23,326 net total. 

2) The one-year window of exposure has a total of 23,567 case/controls with a **total of 3,924 cases** specifically and ***19,643 controls***. This means **28 cases** from the original data have zero observations during this year. That is, the data is missing ***0.7%*** of cases from the original dataset

3) Overall 92 out of 23,326 cases/controls **(0.39%)** are missing one or more of the 12 months for the one year exposure window
