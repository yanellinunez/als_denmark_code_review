...
- Use a natural spline with 3 degrees of freedom to test for non-linearities in the outcome-exposure relationship. 
...
Note: these models were not adjusted by Parish level SES
