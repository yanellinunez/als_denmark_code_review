...
#### iii. Lag constrain with 3 df adjusted for parish SES

The model with a lag constrain of 3 has the lowest AIC so here I'm running the model again but adjusted for parish SES
...
## 6. Compile and save effect estimates
